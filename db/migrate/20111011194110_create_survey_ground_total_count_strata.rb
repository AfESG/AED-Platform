class CreateSurveyGroundTotalCountStrata < ActiveRecord::Migration
  def self.up
    create_table :survey_ground_total_count_strata do |t|
  ...
  def self.down
    drop_table :survey_ground_total_count_strata
  end
end
